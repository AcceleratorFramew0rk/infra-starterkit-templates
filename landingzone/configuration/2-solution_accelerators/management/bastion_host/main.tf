...
module "azure_bastion" {
  ...
  sku                 = try(local.global_settings.environment, var.environment) != "prd" ? "Developer" : "Premium" # "Developer" or "Standard" or "Premium" # for session recording preview
  ip_configuration    = {
  ...
  zones = try(local.global_settings.environment, var.environment) != "prd" ? []  : ["1", "2", "3"] # ["1"] # default is ["1", "2", "3"]
