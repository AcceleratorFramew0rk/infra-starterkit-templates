...
variable "vnet_type" {
  type        = string  
  default = "devops"  # # "" or "project" or "devops" 
}

variable "vnet_name" {
  type        = string  
  default = "spoke_devops"  # # "" or "spoke_project" or "spoke_devops" 
}

# allow cusomization of the private endpoint subnet name
variable "subnet_name" {
  type        = string  
  default = "RunnerVmSubnet"
}
...
variable "encryption_at_host_enabled" {
  type        = bool  
  default = false  # true # The property 'securityProfile.encryptionAtHost' is not valid because the 'Microsoft.Compute/EncryptionAtHost' feature is not enabled for this subscription.
}
