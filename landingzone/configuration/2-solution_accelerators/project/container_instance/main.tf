...
module "container_group1" {
  ...
  os_type             = "Linux"
  subnet_ids          = [try(local.remote.networking.virtual_networks[var.vnet_name].virtual_subnets[var.subnet_name].resource.id, null) != null ? local.remote.networking.virtual_networks[var.vnet_name].virtual_subnets[var.subnet_name].resource.id : var.subnet_id  ]
