module "virtual_subnet1" {
  ...
  parent_id                                     = local.remote.networking.virtual_networks.spoke_project.virtual_network.id
...
locals {
  route_table = {
    id = "/subscriptions/65a69247-6679-4570-a790-4aa90b5a6831/resourceGroups/rg-esp-prd-r1-001/providers/Microsoft.Network/routeTables/rt-esp-prd-r1-defaultroutetohub1fw"
  }
}